...
public class NotificationController : ControllerBase
{
    ...
    public async Task<ActionResult<object>> GetNotificationByIdAsync(int notificationId)
    {
        try
        {
            ...
            var test = await this.GetPostReactNotificationByIdAsync(notificationId);
    ...
    private async Task<FollowNotificationResponseModel> GetFollowNotificationByIdAsync(int notifictionId)
    {
        try
        {
    ...
    private async Task<ShareNotificationResponseModel> GetShareNotificationByIdAsync(int notifictionId)
    {
        try
        {
    ...
    private async Task<ShareNotificationResponseModel> GetPostShareNotificationByIdAsync(int notifictionId)
    {
        try
        {
    ...
    private async Task<CommentNotificationResponseModel> GetCommentNotificationByIdAsync(int notifictionId)
    {
        try
        {
    ...
    private async Task<CommentNotificationResponseModel> GetPostCommentNotificationByIdAsync(int notifictionId)
    {
        try
        {
    ...
    private async Task<CommentReactNotificationResponseModel> GetCommentReactNotificationByIdAsync(int notifictionId)
    {
        try
        {
    ...
    private async Task<CommentReactNotificationResponseModel> GetPostCommentReactNotificationByIdAsync(int notifictionId)
    {
        try
        {
    ...
    private async Task<PostReactNotificationResponseModel> GetPostReactNotificationByIdAsync(int notifictionId)
    {
        try
        {
    ...
    public async Task<ActionResult> MarkNotificationAsSeenAsync(int NotificationId)
    {
        try
        {
            await _notificationRepository.MarkNotificationAsSeenAsync(NotificationId);
            return Ok();
        }
        catch (Exception ex)
        {
