...
namespace QuranHub.DAL.Migrations.IdentityData
{
    ...
    [Migration("20260329202642_edit-notifications-table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GroupVerse", b =>
                {
                    b.Property<int>("GroupsGroupId")
                        .HasColumnType("int");

                    b.Property<int>("VersesVerseId")
                        .HasColumnType("int");

                    b.HasKey("GroupsGroupId", "VersesVerseId");

                    b.HasIndex("VersesVerseId");

                    b.ToTable("GroupVerse");
                });
            ...
            modelBuilder.Entity("QuranHub.Domain.Models.Group", b =>
                {
            ...
            modelBuilder.Entity("GroupVerse", b =>
                {
                    b.HasOne("QuranHub.Domain.Models.Group", null)
                        .WithMany()
                        .HasForeignKey("GroupsGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QuranHub.Domain.Models.Verse", null)
                        .WithMany()
                        .HasForeignKey("VersesVerseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
